...
sudo nohup ./lite-linux-amd64 --config ./lite_config.json --test https://raw.githubusercontent.com/lagzian/IranConfigCollector/main/bulk/b65_merge1.txt >speedtest.log 2>&1 &
